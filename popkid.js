...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj3 = "254748840328";
            const luffy = '254790342984';
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("🍀 Sonic Md Connected to WhatsApp! 🍀");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Sonic Md is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading Sonic Md Commands ...\n");
